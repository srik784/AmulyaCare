...
public class Specialities extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_specialities, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_exit) {
            AlertDialog.Builder builder=new AlertDialog.Builder(Specialities.this); //Home is name of the activity
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                ...
                case 1:
                    ...
                    return  stress;
                case 2:
                    LowBackPain lowBackPain=new LowBackPain();
                    return  lowBackPain;
                case 3:
                    CervicalPain cervicalpain=new CervicalPain();
                    return  cervicalpain;
                case 4:
